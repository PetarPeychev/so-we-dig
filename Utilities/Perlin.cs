...
namespace SoWeDig.Utilities
{
    ...
    class Perlin
    {
        ...
        public Perlin(double frequency, int randomSeed)
        {
            persistence = 1;
            amplitude = 1;
            octaves = 1;
        ...
        private double PerlinNoise1D(int x, int seed)
        {
        ...
        private double NoiseSeamless2D(int x, int y, int seed, int w, int h)
        {
            double total = 0;
        ...
        private double NoiseSeamlessX2D(int x, int y, int seed, int w)
        {
        ...
        private double InterpolateCubic(double v0, double v1, double v2, double v3, float x)
        {
        ...
        private double Smooth1D(int x, int seed)
        {
            // 1/4 + 1/4 + 1/2 = 1;
